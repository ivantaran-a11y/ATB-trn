...
Generated: 2026-01-20T13:23:29.461Z
...
- [27. В каком банке я могу получить карту АТБ?](#item-27)
- [28. По акції Диволови QR-код не зчитується/сканується, чому?](#item-28)
- [29. По акції Диволови Як зареєструвати код з Е-чеку? ](#item-29)
- [30. По акції Диволови Я не можу зареєструвати код з чеку, чому?](#item-30)
- [31. По акції Диволови В Особистому кабінеті по коду я бачу статус:  

«Код не пройшов перевірку. Ви можете звернутись на гарячу лінію», чому?](#item-31)
- [32. По акції Диволови Коли і де буде розіграш?](#item-32)
- [33. Почему доставка опаздывает?](#item-33)
- [34. Де подивитись картки у додатку АТБ?](#item-34)
- [35. Причини, чому каса може не прийняти купюру](#item-35)
- [36. Як працевлаштуватись у АТБ?](#item-36)
- [37. Чи надає АТБ бронювання від мобілізації при працевлаштуванні?](#item-37)
- [38. Як встановити та на яких телефонах працює мобільний застосунок АТБ?](#item-38)
- [39. Які мови інтерфейсу підтримує мобільний застосунок АТБ і як перемкнути мову?](#item-39)
- [40. Як зареєструватися та увійти в мобільний застосунок АТБ і що робити, якщо не приходить SMS-код?](#item-40)
- [41. Як налаштувати вхід через PIN та біометрію в мобільному застосунку АТБ і що робити, якщо біометрія не працює?](#item-41)
- [42. Як пройти або перезапустити навчання (онбординг) у мобільному застосунку АТБ?](#item-42)
- [43. Як керувати персональними даними у мобільному застосунку АТБ (редагування, очищення)?](#item-43)
- [44. Як користуватися сервісом «Акції» у мобільному застосунку АТБ (типи, сортування, фільтри, покупка)?](#item-44)
- [45. Як користуватися сервісом Scan&Buy у мобільному застосунку АТБ і чи підтягнеться історія з «Скануй Купуй»?](#item-45)
- [46. Як замовляти та відстежувати замовлення в інтернет-магазині мобільного застосунку АТБ?](#item-46)
- [47. Як знайти магазин і прокласти маршрут через сервіс «Карта» у мобільному застосунку АТБ?](#item-47)
- [48. Як звернутися в сервіс «Контакти/Підтримка» у мобільному застосунку АТБ і які канали доступні?](#item-48)
- [49. Як шукати, відгукуватися та підписуватися на вакансії в сервісі «Вакансії» мобільного застосунку АТБ?](#item-49)
- [50. Як увімкнути або вимкнути push-сповіщення від мобільного застосунку АТБ?](#item-50)
- [51. З якої дати можна розраховуватися «зимовою тисячею» в магазинах АТБ?](#item-51)
- [52. Чи діє програма «Зимова тисяча» у всіх магазинах АТБ?](#item-52)
- [53. Які саме товари можна оплатити «зимовою тисячею» та як їх відрізнити в магазині?](#item-53)
- [54. Чи можна оплатити алкоголь або тютюнові вироби «зимовою тисячею»?](#item-54)
- [55. Куди звертатися покупцю, якщо «зимова тисяча» не списується під час оплати?](#item-55)
...
### 27. В каком банке я могу получить карту АТБ?
<a id="item-27"></a>
...
### 28. По акції Диволови QR-код не зчитується/сканується, чому?
<a id="item-28"></a>
...
### 29. По акції Диволови Як зареєструвати код з Е-чеку? 
<a id="item-29"></a>
...
### 30. По акції Диволови Я не можу зареєструвати код з чеку, чому?
<a id="item-30"></a>
...
### 32. По акції Диволови Коли і де буде розіграш?
<a id="item-32"></a>
...
### 34. Де подивитись картки у додатку АТБ?
<a id="item-34"></a>
...
### 35. Причини, чому каса може не прийняти купюру
<a id="item-35"></a>
...
### 37. Чи надає АТБ бронювання від мобілізації при працевлаштуванні?
<a id="item-37"></a>
...
### 38. Як встановити та на яких телефонах працює мобільний застосунок АТБ?
<a id="item-38"></a>
...
### 39. Які мови інтерфейсу підтримує мобільний застосунок АТБ і як перемкнути мову?
<a id="item-39"></a>
...
### 40. Як зареєструватися та увійти в мобільний застосунок АТБ і що робити, якщо не приходить SMS-код?
<a id="item-40"></a>
...
### 41. Як налаштувати вхід через PIN та біометрію в мобільному застосунку АТБ і що робити, якщо біометрія не працює?
<a id="item-41"></a>
...
### 42. Як пройти або перезапустити навчання (онбординг) у мобільному застосунку АТБ?
<a id="item-42"></a>
...
### 43. Як керувати персональними даними у мобільному застосунку АТБ (редагування, очищення)?
<a id="item-43"></a>
...
### 44. Як користуватися сервісом «Акції» у мобільному застосунку АТБ (типи, сортування, фільтри, покупка)?
<a id="item-44"></a>
...
### 45. Як користуватися сервісом Scan&Buy у мобільному застосунку АТБ і чи підтягнеться історія з «Скануй Купуй»?
<a id="item-45"></a>
...
### 46. Як замовляти та відстежувати замовлення в інтернет-магазині мобільного застосунку АТБ?
<a id="item-46"></a>
...
### 47. Як знайти магазин і прокласти маршрут через сервіс «Карта» у мобільному застосунку АТБ?
<a id="item-47"></a>
...
### 48. Як звернутися в сервіс «Контакти/Підтримка» у мобільному застосунку АТБ і які канали доступні?
<a id="item-48"></a>
...
У мобільному застосунку АТБ відкрийте Інфо → Контакти/Підтримка. Там є кнопка дзвінка на гарячу лінію та офіційні канали: Viber, WhatsApp, Facebook, Instagram, Telegram, X/Twitter, TikTok, YouTube.

---

### 49. Як шукати, відгукуватися та підписуватися на вакансії в сервісі «Вакансії» мобільного застосунку АТБ?
<a id="item-49"></a>
...
### 50. Як увімкнути або вимкнути push-сповіщення від мобільного застосунку АТБ?
<a id="item-50"></a>
...
### 51. З якої дати можна розраховуватися «зимовою тисячею» в магазинах АТБ?
<a id="item-51"></a>
...
### 52. Чи діє програма «Зимова тисяча» у всіх магазинах АТБ?
<a id="item-52"></a>
...
### 53. Які саме товари можна оплатити «зимовою тисячею» та як їх відрізнити в магазині?
<a id="item-53"></a>
...
### 54. Чи можна оплатити алкоголь або тютюнові вироби «зимовою тисячею»?
<a id="item-54"></a>
...
### 55. Куди звертатися покупцю, якщо «зимова тисяча» не списується під час оплати?
<a id="item-55"></a>
